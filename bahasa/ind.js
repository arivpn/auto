...
exports.noregis = () => {
	return`──「 DAFTAR 」──\nHalo gan !\nKamu belum Terdaftar didalam database, \n\nCommand : ${prefix}daftar nama|umur\nContoh : ${prefix}daftar aritube|30\n\n──「 ARIE BOT 」──`
}

exports.rediregis = () => {
	return`* [ SUDAH TERDAFTAR 」*\n\n*Kamu sudah terdaftar di database Arie Tube*`
}
...
exports.bug = () => {
	return`*Masalah telah di laporkan ke owner hermanツ, Laporan palsu atau main² tidak akan ditanggapi.*`
}

exports.wrongf = () => {
	return`Pendaftaran Salah\nCommand : ${prefix}daftar nama|umur\nContoh : ${prefix}daftar herman|17`
}
...
exports.registered = (namaUser, umurUser, serialUser, time, sender) => {
	return`*「 DATA PENYEMBAH ARIE TUBE 」*\n\nkamu sudah terdaftar dengan data \n\n┏━⊱nama\n┗⊱${namaUser}\n┏━⊱nomer\n┗⊱wa.me/${sender.split("@")[0]}\n┏━⊱umur\n┗⊱${umurUser}\n┏━⊱waktu pendaftaran\n┗⊱${time}\n\n┏━❉ *NS* ❉━\n┣⊱${serialUser}\n┗⊱NOTE : jangan sampai lupa nomer ini ntar kena baned! katanya:V`
}
...
exports.limitend = (pushname) => {
	return`*Maaf ${pushname} limit hari ini habis*\n*Hubungi kami* : wa.me/6288245009287\n\n*Note : Kami akan berikan random dari 1-10*`
}
