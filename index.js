...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:ARIE TUBE\n' //ganti nama lu! 
            + 'ORG: Owner ARIETUBE;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6288245009287:+62 88245009287\n'  //ganti nomor lu! 
            + 'END:VCARD'
...
const vcard2 = 'BEGIN:VCARD\n' 
            ...
            + 'FN:ARIE BOT\n' //ganti nama lu! 
            + 'ORG: Owner ARIETUBE;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6288245009287:+62 8314628804\n'  //ganti nomor lu! 
            + 'END:VCARD'
...
memberlimit = 1
vr = '*私は静かな人です*'
ve = '*HALO KAK BAGI YANG BLOM TAU ITU OWNER ARIETUBE BOT YANG ASLI*'
vo = '*STATUS SELF AKTIF*'
vu = '*BEBAN KELUARGA KE TAG*'
cr = '*LARI ADA WIBU*'
va = '*YAHAHAHAH KE TAG PARAH SIH*'
reply ='*POWORED BY ARIETUBE BOT*'
FRISLAH ='*Gila Kali Bah*'
/******** OWNER NUMBER**********/
const ownerNumber = ["6288245009287@s.whatsapp.net","6288245009287@s.whatsapp.net","6288245009287@s.whatsapp.net","6288245009287@s.whatsapp.net"]   //ganti nomor lu! 
const pacarNumber = ["6281275768751@s.whatsapp.net"]  //ganti nomor lu!  
/************************************/
...
console.log(banner.string)
   ...
   qrcode.generate(qr, { small: true })
	console.log(color('(+)','white'), color('SUPORT','red'), color('(+)','white'), color(' SQAN CODENYA','aqua'), color('SUBREK YT ARIETUBE CHANEL','yellow'))
})
...
const expiredCheck = () => {
		...
		reply(`LINK GRUP TERDETEKSI MAAF ${sender.split("@")[0]} SEBENTAR LAGI KAMU AKAN DI KICK DARI GRUP`)
		setTimeout( () => {
		...
		setTimeout( () => {
			...
			if (!isCmd && isGroup) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;31mRECV\x1b[1;37m]', time, color('Message'), 'from', color(sender.split('@')[0]), 'in', color(groupName), 'args :', color(args.length))
              ...
              switch(command) {
///  MENU MAKER UPDATE BY ARIETUBE CHANEL
case 'wetglass':
                case 'multicolor3d':
                case 'watercolor':
                case 'luxurygold':
...
case 'logoepep': 
		...
		case 'logoepep5': 
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				if (args.length < 1) return reply('Teksnya mana um')
				costum('SABAR LAGI PROSES NJING!!!', text, tescuk, cr)
...
case 'addbadword':  // By ArieTube*
                   ...
                   await reply(lbw)
                    break 
                    case 'getsticker':
				case 'gets':  // By ArieTube
					namastc = body.slice(12)
					result = fs.readFileSync(`./strg/sticker/${namastc}.webp`)
					client.sendMessage(from, result, sticker, {quoted :mek})
					break
					case 'stickerlist':
				case 'liststicker':  // By ArieTube
					teks = '*Sticker List :*\n\n'
				...
				case 'addvideo':  // By ArieTube
					...
					break
				case 'getvideo':  // By ArieTube
					namastc = body.slice(10)
					buffer = fs.readFileSync(`./strg/video/${namastc}.mp4`)
					client.sendMessage(from, buffer, video, { mimetype: 'video/mp4', quoted: mek })
					break
				case 'listvideo':
				case 'videolist':  // By ArieTube
					teks = '*List Video :*\n\n'
...
case 'snk':
		...
		case 'request':
					...
					client.sendMessage('6288245009287@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('6288245009287@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('6283246208804@s.whatsapp.net', options, text, {quoted: mek})
					reply('REQUEST ANDA TELAH SAMPAI KE OWNER ARIETUBE BOTZ, Requests palsu atau main² tidak akan ditanggapi.')
					break
					case 'setppbot':
					if (!isOwner) return reply(ind.ownerb())
				    client.updatePresence(from, Presence.composing) 
...
case 'infoowner':
                       ...
                       if (!isRegistered) return reply( ind.noregis())
				       if (isLimit(sender)) return reply(ind.limitend(pusname))
				const srd = "6288245009287@s.whatsapp.net"
				const bjir = `
╔════ ◤ *Info Developer* ◢
║╔▸ 
║╠ *Nama* : Hermansyah
...
teks = `*JASA CULIK MEMBER BY ARIETUBE CHANEL*

50MEM:2K
100MEM:5K
150MEM:7K
FULL:10K
Chat:wa.me/6288245009287`
...
MINAT? BISA CHAT:wa.me/6288245009287
©ARIETUBE CHANEL`
                client.sendMessage(from, wew, image, { quoted: mek, caption: teks })
                break	
case 'buatlogojb':
            if (!isRegistered) return reply(ind.noregis())
             if (isBanned) return reply(ind.baned())
                wew = fs.readFileSync(`./src/LogooBott.jpg`)
teks = `╭≽ *「JASA DESAIN LOGO BY ARIETUBE CHANEL」*
*LOGO/VEKTOR
...
http://wa.me/6288245009287`
                client.sendMessage(from, wew, image, { quoted: mek, caption: teks })
                break	
case 'suntikig':
            if (!isRegistered) return reply(ind.noregis())
             if (isBanned) return reply(ind.baned())
                wew = fs.readFileSync(`./src/HERMAN.jpg`)
...
WhatsApp :https://wa.me/+6288245009287`
                client.sendMessage(from, wew, image, { quoted: mek, caption: teks })
                break
case 'jasashare':
            if (!isRegistered) return reply(ind.noregis())
             if (isBanned) return reply(ind.baned())
                wew = fs.readFileSync(`./src/KONTOL.jpg`)
teks = `*JASA SHARE MURMER BY ARIETUBE CHANEL*
...
*KONTAK :https://wa.me/6288245009287`
                client.sendMessage(from, wew, image, { quoted: mek, caption: teks })
                break	
case 'PEMBAYARAN':
            if (!isRegistered) return reply(ind.noregis())
...
case 'ttp':
                ...
                case 'ttp4':
                case 'attp':
                    if (args.length == 0) return reply(`Example: ${prefix + command} HermanGans`)
                    ini_txt = args.join(" ")
...
case 'base64enc': 
				if (!isRegistered) return reply(ind.noregis())
				if (args.length < 1) return reply(`Contoh: Herman chanel 🐨`)
					auah = body.slice(11)
...
client.sendMessage(from, Vali, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
       ...
       if (budy.includes(`@6288245009287`)) {
